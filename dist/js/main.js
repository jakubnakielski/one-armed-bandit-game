...
/***/ "./src/js/getComputedColors.js":
/*!*************************************!*\
  !*** ./src/js/getComputedColors.js ***!
  \*************************************/
/*! exports provided: getComputedColors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getComputedColors\", function() { return getComputedColors; });\nfunction getComputedColors() {\r\n  const colors = [];\r\n  const boxes = document.querySelectorAll('.boxesContainer__box');\r\n\r\n  for (const box of boxes) {\r\n    const compStyles = getComputedStyle(box);\r\n    const color = compStyles.getPropertyValue('background-image');\r\n    colors.push(color);\r\n  }\r\n\r\n  return colors;\r\n}\n\n//# sourceURL=webpack:///./src/js/getComputedColors.js?");
